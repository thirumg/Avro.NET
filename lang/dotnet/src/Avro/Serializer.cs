...
namespace Avro
{
    ...
    public static class Serializer
    {
        ...
        private static Dictionary<long, MethodInfo> encoderMethodLookup = new Dictionary<long, MethodInfo>();
        private static Dictionary<long, MethodInfo> decodeMethodLookup = new Dictionary<long, MethodInfo>();

        private static Dictionary<Type, MethodInfo> encoderMethods;
        private static Dictionary<Type, MethodInfo> decoderMethods;
        ...
        private static Dictionary<Type, MethodInfo> dumpMethods(Type type, MethodType methodType, string Prefix)
        {
        ...
        private static MethodInfo getMethodInfo(MethodType methodType, Schema schema, Type dataType)
        {
        ...
        #region Arrays
        private static void validateArrayType(Type type)
        {
            if (!type.IsArray)
        ...
        private static Type[] getEncoderMethodArgs(Type type)
        {
            return new Type[] { typeof(Stream), typeof(Encoder), type };
        }
        private static Type[] getDecoderMethodArgs(Type type)
        {
        ...
        /// <summary>
        /// Method is used to return the SetValue method of the internal class ArrayHelper<>. This
        /// allows us to generate a call directly to the method based on the specific type of array being serialized 
        /// preventing the compiler from boxing and unboxing. 
        /// </summary>
        /// <param name="elementType">The type of array being manipulated.</param>
        /// <returns>Method info for the method to be called.</returns>
        ...
        /// <summary>
        /// Method is used to return the GetValue method of the internal class ArrayHelper<>. This
        /// allows us to generate a call directly to the method based on the specific type of array being serialized 
        /// preventing the compiler from boxing and unboxing. 
        /// </summary>
        /// <param name="elementType">The type of array being manipulated.</param>
